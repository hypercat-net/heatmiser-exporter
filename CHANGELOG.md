...
- Omit metric families that have no samples on a scrape (no empty `# HELP` /
  `# TYPE` blocks for cool series on heat-only hubs, etc.)
- Document heat / cool / heat+cool metric differences in the metrics guide
  and README
